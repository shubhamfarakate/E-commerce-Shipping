...
def predict():
    ...
    if request.method == 'POST':
        ...
        prediction=model.predict([[Customer_care_calls, Customer_rating, Cost_of_the_Product, Weight_in_gms, Discount_offered, Prior_purchases, WH_Block_B, WH_Block_C, WH_Block_D, WH_Block_E, Mode_of_S_Road, Mode_of_S_Ship, Gender_M, Product_Importance]])
